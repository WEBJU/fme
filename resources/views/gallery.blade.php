...
<html lang="en">
<head>
  <title>FOMO Events &mdash; Gallery</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2" data-aos="fade-down">
            <h1 class="mb-0"><a href="../index.html" class="text-white h2 mb-0">FOMO</a></h1>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_1.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_2.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_3.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_4.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_5.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_6.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="gallery/images/img_7.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
  ...
  <script src="gallery/js/swiper.min.js"></script>
  <script src="gallery/js/aos.js"></script>

  <script src="gallery/js/picturefill.min.js"></script>
  <script src="gallery/js/lightgallery-all.min.js"></script>
  <script src="gallery/js/jquery.mousewheel.min.js"></script>
