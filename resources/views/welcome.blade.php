        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img style="height: 80px;"  src="assets/img/logo/Logo.png" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-9">
                            ...
                            <div class="hero__caption">
                                <span>FOMO Events</span>
                                <h1>Never Miss A Plan</h1>
                            </div>
                            <!--Hero form -->
                                ...
                                <div class="select-form">
                                    <div class="select-itms">
                                        <select name="select" id="select1">
                                            ...
                                            <option value="6">Festivals / Concerts</option>
                                            <option value="5">Restaurants</option>
                                            <option value="3">Things To Do</option>
                                            <option value="4">Accomodation</option>
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="col-md-3">
                  <div class="card card-margin">
                    ...
                    <div class="card-header no-border">
                      <a href="{{route('events.show',$event->id)}}" class="card-title" style="color:#6f42c1">{{$event->title}}</a>
                    </div>
                    <div class="card-body pt-0">
                      <div class="widget-49">
                        ...
                        <div class="widget-49-meeting-info">
                          ...
                          <span class="widget-49-meeting-time">{{$event->sales_start_time}} to {{$event->sales_end_time}} Hrs</span>
                        </div>
                      </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="catagori.html">Accomodation</a></h5>
