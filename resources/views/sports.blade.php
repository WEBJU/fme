...
<div class="search" style="margin-top:115px;">
  <h4 class="register-text">Welcome to your sports feed</h4>
  <input type="text" name="" class="cust" value="" placeholder="Search your favorite sports events happening near you..">
</div>
<div class="container" style="margin-top:50px;">

  <p class="upcoming">Upcoming sports events..</p>
  <hr class="line">
  <style media="screen">
  .upcoming{
    color: #2b5876;
          ...
          <div class="widget-49">
            <div class="widget-49-title-wrapper">
              <div class="widget-49-date-primary">
                ...
                <span class="widget-49-date-month">Aug</span>
              </div>
              <div class="widget-49-meeting-info">
                <span class="widget-49-pro-title">Anfield</span>
                <span class="widget-49-meeting-time">19:30 to 21:30 Hrs</span>
              </div>
            </div>
            <ol class="widget-49-meeting-points">
              <li class="widget-49-meeting-item"><span>The match kickoff will be at 10pm</span></li>
              <li class="widget-49-meeting-item"><span>Fans are expected to be sitted early</span></li>
            </ol>
  ...
  <div class="col-lg-4">
    <div class="card card-margin">
      <img src="/images/premier.jpg" class="event-image" alt="">
      <div class="card-header no-border">
        <h5 class="card-title">Liverpool V Chelsea</h5>
      </div>
      <div class="card-body pt-0">
        <div class="widget-49">
          <div class="widget-49-title-wrapper">
          ...
          <div class="widget-49-meeting-action">
            <a href="#" class="btn btn-sm btn-flash-border-warning">More Info</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card card-margin">
      ...
      <div class="card-body pt-0">
        <div class="widget-49">
          ...
          <div class="widget-49-meeting-action">
            <a href="#" class="btn btn-sm btn-flash-border-success">More Info</a>
          </div>
        </div>
      </div>
    </div>
