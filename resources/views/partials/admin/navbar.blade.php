<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="/"><img class="main-logo imgg-responsive" src="assets/img/logo/Logo.png" style="max-width: 100px;" alt="" /></a>
            <strong><img src="assets/img/logo/Logo.png" style="max-width: 50px;" alt="" /></strong>
        </div>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Email Marketing</span></a>
